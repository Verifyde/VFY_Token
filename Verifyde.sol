...
contract Verifyde is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Verifyde";
    string private constant _symbol   = "VFY";
    ...
    function setMinLiquidityPercent(uint256 minLiquidityPercent) external onlyOwner {
        _numTokensSellToAddToLiquidity = _tTotal.mul(minLiquidityPercent).div(10000);
    }
